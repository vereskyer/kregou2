...
@section('content')
    ...
    <main class="mt-6">
        ...
        <div class="mt-10 w-11/12 md:w-3/4 lg:max-w-3xl m-auto">
                ...
                @foreach ($stores as $store)
                    <div
                        ...
                        <div class="stat-figure text-secondary">
                            <a id="payButton" href="{{ route('store.payment', ['id' => $store->id]) }}" class="common_btn">
                        ...
                        <div class="stat-desc text-secondary flex items-center space-x-2 mt-1">
                            <div class="flex items-center flex-grow"> <!-- Updated this line -->
                                ...
                                {{-- wechat  --}}
                                @if ($store->wechat)
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" aria-label="WeChat"
                                ...
                                {{-- site      --}}
                                @if ($store->website)
                                    <svg class="w-5 h-5" fill="orange" height="200px" version="1.1" id="Capa_1"
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        viewBox="0 0 360 360" xml:space="preserve" stroke="#0e1ce1">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                        <g id="SVGRepo_iconCarrier">
                                            <path
