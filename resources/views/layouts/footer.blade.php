<footer class="bg-sky-400 rounded-lg mt-10 mb-5">
    ...
    <div class="">
        <div class="max-w-screen-lg px-4 sm:px-6 text-gray-800 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
            <div class="p-5">
                <h3 class="font-bold text-xl text-indigo-600">韓國易購</h3>
            </div>
            <div class="p-5">
            ...
            <div class="p-5">
                ...
                <a class="my-3 block" href="/#">서울 동대문구 한천로 24길 31번 1층 천한무역
                    <span class="text-teal-600 text-xs p-1"></span></a><a class="my-3 block" href="/#">Line:
                    bizkorea
                    <span class="text-teal-600 text-xs p-1"></span></a>
            </div>
        </div>
        ...
        <div
          ...
          max-w-screen-lg items-center">
            <div class="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
                ...
                <a href="https://www.facebook.com/groups/326480931465380" class="w-6 mx-1">
