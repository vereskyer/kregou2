...
<main class="mt-6">
    ...
    <div class="grid mt-8 gap-8 grid-cols-5">
        <article
            class="Z4gs6uHncJ3wh8Y8wfxKew== group min-h-card YoFd2uyxHxI2id7VAPDwbA== snap-start relative max-h-cardLarge h-full flex flex-col p-2 rounded-16 bg-background-subtle border border-border-subtlest-tertiary hover:border-border-subtlest-secondary shadow-2"
            data-testid="postItem">
            <button title="How to develop a smart contract on Berachain with Solidity"
                class="t0OTVVeiqs3ndQVyCHDStQ== focus-outline absolute inset-0 h-full w-full">
            </button>
            <div class="flex flex-1 flex-col">
                <div class="flex flex-col mx-2">
                    <div class="flex nwnTAVpHpXXlnqXlqgyhZA== items-center h-8 my-1 mt-2 -mx-1.5">
                        <a aria-label="Coins Bench" class="flex min-w-0 shrink items-center no-underline"
                        ...
                        <span class="ml-auto flex flex-row laptop:mouse:invisible laptop:mouse:group-hover:visible"
                            ...
                            <a target="_blank" href="https://api.daily.dev/r/KEXlqdAPA"
                                class="btn shadow-none focus-outline inline-flex cursor-pointer select-none
                                    flex-row items-center border no-underline transition
                                    duration-200 ease-in-out typo-callout justify-center font-bold h-8 px-3 rounded-10 btn-primary mr-2">Read
                                post
                    ...
                    <h3
                        class="OtAXne+qfhxhpZDfYpk7WQ== multi-truncate font-bold text-text-primary typo-title3 line-clamp-3 mt-2 break-words">
                    ...
                    <div class="ml-3 flex flex-row items-center justify-between">
                        <div
                            ...
                            <button aria-label="Upvote" id="post-KEXlqdAPA-upvote-btn" aria-pressed="false"
                                class="btn shadow-none focus-outline inline-flex cursor-pointer select-none
                                    flex-row items-center border no-underline transition
                                    duration-200 ease-in-out typo-callout justify-center font-bold iconOnly h-8 w-8 p-0 rounded-10">
                                <svg width="1em" height="1em" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 pointer-events-none">
                                    <path
        ...
        <article
            ...
            <div class="flex flex-1 flex-col">
                <div class="flex flex-col mx-2">
                    ...
                    <h3
                        class="OtAXne+qfhxhpZDfYpk7WQ== multi-truncate font-bold text-text-primary typo-title3 line-clamp-3 mt-2 break-words">
                        How to develop a smart contract on Berachain with Solidity  with Solidity with Solidity
                    </h3>
                </div>
