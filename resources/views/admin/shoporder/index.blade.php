                                ...
                                <tr class="text-gray-700 dark:text-gray-400">
                                    <td class="px-4 py-3">
                                        <div class="flex items-center text-sm">
                                            ...
                                            <div>
                                                <p class="font-semibold">{{ $shoporder->user->name }}</p>
                                    ...
                                    <td class="px-4 py-3 text-xs">{{ $shoporder->handphone }}</td>
                                    <td class="px-4 py-3 text-sm">{{ $shoporder->kakao }}</td>
                                    <td class="px-4 py-3 text-sm">{{ $shoporder->wechat }}</td>
                                    <td class="px-4 py-3 text-sm">{{ $shoporder->line }}</td>
                                    <td class="px-4 py-3 text-sm">{{ $shoporder->instagram }}</td>
                                    <td class="px-4 py-3 text-sm">{{ $shoporder->website }}</td>
                                    <td class="px-4 py-3">
