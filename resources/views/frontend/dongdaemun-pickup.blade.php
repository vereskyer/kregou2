    ...
    <div class="p-4 max-w-xl mx-auto dark:bg-gray-800">
        ...
        <div class="flex">
            <div class="mr-4 flex flex-col items-center">
                <div>
                    <div class="flex h-10 w-10 items-center justify-center rounded-full  border-blue-900">
                        <svg fill="#56B48C" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
