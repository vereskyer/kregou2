...
<main class="mt-10 pl-6 h-screen pb-16 overflow-y-auto">
    <div class="p-4" data-theme="emerald">
        <form id="shop-order-form" method="POST" action="{{ route('user.shoporder.store') }}">
            ...
            <div>
                <input type="text" id="store-search" placeholder="檔口名稱" name="store_name"
                    class="mt-4 input input-bordered input-primary w-full max-w-xs" />
                <div id="search-results" class="mt-2 bg-white shadow-lg"></div>
            </div>
            <div>
                <input type="text" id="building" placeholder="所屬大樓" name="building"
                    class="mt-4 input input-bordered input-primary w-full max-w-xs" />
            </div>
            <div>
                <input type="text" id="floor" placeholder="所屬樓層" name="floor"
                    class="mt-4 input input-bordered input-primary w-full max-w-xs" />
            </div>
            <div>
                <input type="text" id="position" placeholder="位置" name="position"
                    class="mt-4 input input-bordered input-primary w-full max-w-xs" />
            </div>
            <div>
            ...
            <div>
                <input type="text" id="description" placeholder="其他說明" name="description"
                    class="mt-4 input input-bordered input-primary w-full max-w-xs" />
            </div>
