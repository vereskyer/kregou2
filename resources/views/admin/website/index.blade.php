                        ...
                        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            @forelse ($websites as $website)
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3 text-xs">{{ $website->url }}</td>
                                    <td class="px-4 py-3 text-sm">{{ $website->description }}</td>
                                    <td class="px-4 py-3 text-sm">{{ $website->tag }}</td>
                                    <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                            <a href="{{ route('admin.websites.update', $website->id) }}">
                                            <button
